...
const experienceOptions = ['Tier 1', 'Tier 2', 'Tier 3', 'None'];
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          A simulator where you get to choose your starting point and develop as
          a player and a professional.
        </div>
        {submitted && apiResult && !showToast ? (
          <div
            style={{ color: '#a3e635', margin: '24px 0', textAlign: 'center' }}
          >
            <div
            ...
            <div
              style={{ color: '#cbd5e1', fontSize: '0.98rem', marginBottom: 8 }}
            >
              ...
              >
                {JSON.stringify(apiResult.career_info, null, 2)}
              </pre>
            </div>
            <button
              onClick={onClose}
          ...
          <div
            style={{ color: '#f87171', margin: '24px 0', textAlign: 'center' }}
          >
            {error || 'Unknown error.'}
          </div>
        ) : loading ? (
          <div
            style={{ color: '#6366f1', margin: '24px 0', textAlign: 'center' }}
          >
          ...
          >
            <label
              style={{ color: '#cbd5e1', fontWeight: 500, marginBottom: 4 }}
            >
              Age
              <input
                type="number"
            ...
            >
              ...
              <select
                value={
                  rankOptions.indexOf(rank) < 7 && rank ? 'None' : experience
                }
