...
import LandingModal from '../../components/landing/modal.jsx';
...
const Landing = () => {
  ...
  return (
    <>
      ...
      >
                    ...
                    style={{
                      ...
                      border:
                        activeIdx === idx
                          ...
                          : '3px solid #2d3748',
                      boxShadow:
                        activeIdx === idx ? '0 0 0 4px #2d3748' : 'none',
        ...
        >
          ...
          >
            ...
            <div
              style={{ textAlign: 'center', color: '#cbd5e1', marginBottom: 8 }}
            >
              Ready to take the next step? Begin your journey and see how far
              you can go!
            </div>
            <button
              disabled={!canStart}
      ...
      {/* Scroll indicator below roadmap */}
      <div
        style={{
          width: '100%',
          display: 'flex',
      ...
      >
        ...
        >
          ...
          >
            Scroll to progress the roadmap
          </span>
          <span
            style={{
              display: 'block',
      ...
      <style>{`
        ...
        `}</style>
      <LandingModal show={showModal} onClose={() => setShowModal(false)} />
    </>
  );
};
